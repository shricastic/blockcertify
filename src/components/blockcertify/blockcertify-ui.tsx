...
import { useBlockcertifyProgram, useBlockcertifyProgramAccount } from './blockcertify-data-access'

export function BlockcertifyCreate() {
  const { initialize } = useBlockcertifyProgram()
...
function BlockcertifyCard({ account }: { account: PublicKey }) {
  const { accountQuery, incrementMutation, setMutation, decrementMutation, closeMutation } = useBlockcertifyProgramAccount({
    account,
  })
